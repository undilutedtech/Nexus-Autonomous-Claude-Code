...
FEATURE_MCP_TOOLS = [
    ...
    "mcp__features__ask_user_question",
    # Code quality and security validation
    "mcp__features__validate_code_quality",
    "mcp__features__get_security_checklist",
    "mcp__features__generate_placeholder_docs",
    # Documentation generation
    "mcp__features__generate_technical_docs",
]

# Skill MCP tools for local skill invocation
SKILL_MCP_TOOLS = [
    "mcp__skills__skill_list",
    "mcp__skills__skill_get",
    "mcp__skills__skill_invoke",
    "mcp__skills__skill_create",
    "mcp__skills__command_list",
    "mcp__skills__command_get",
    "mcp__skills__command_invoke",
]

# Nuxt MCP tools for Nuxt.js documentation and guides
# Remote MCP server at https://nuxt.com/mcp
NUXT_MCP_TOOLS = [
    # Documentation tools
    "mcp__nuxt__list_documentation_pages",
    "mcp__nuxt__get_documentation_page",
    "mcp__nuxt__get_getting_started_guide",
    # Blog tools
    "mcp__nuxt__list_blog_posts",
    "mcp__nuxt__get_blog_post",
    # Deployment tools
    "mcp__nuxt__list_deploy_providers",
    "mcp__nuxt__get_deploy_provider",
    # Guided prompts
    "mcp__nuxt__find_documentation_for_topic",
    "mcp__nuxt__deployment_guide",
    "mcp__nuxt__migration_help",
]
...
def create_client(project_dir: Path, model: str, yolo_mode: bool = False):
    ...
    # Skill tools and Nuxt docs are always included
    allowed_tools = [*BUILTIN_TOOLS, *FEATURE_MCP_TOOLS, *SKILL_MCP_TOOLS, *NUXT_MCP_TOOLS]
    if not yolo_mode:
    ...
    permissions_list = [
        ...
        *FEATURE_MCP_TOOLS,
        # Allow Skill MCP tools for local skill invocation
        *SKILL_MCP_TOOLS,
        # Allow Nuxt MCP tools for documentation access
        *NUXT_MCP_TOOLS,
    ]
    if not yolo_mode:
    ...
    if yolo_mode:
        print("   - MCP servers: features, skills, nuxt - YOLO MODE (no Playwright)")
    else:
        print("   - MCP servers: playwright, features, skills, nuxt")
    print("   - Local skills enabled from .claude/skills/")
    print("   - Nuxt.js docs enabled from https://nuxt.com/mcp")
    print()
    ...
    # Build MCP servers config - features and skills are always included, playwright only in standard mode
    mcp_servers = {
        "features": {
            ...
            "env": {
                ...
                **os.environ,
                ...
                "PYTHONPATH": str(nexus_root),
            },
        },
        "skills": {
            "command": sys.executable,
            "args": ["-m", "mcp_server.skill_mcp"],
            "env": {
                **os.environ,
                "PROJECT_DIR": str(project_dir.resolve()),
        ...
        # Nuxt.js documentation MCP server (remote HTTP)
        "nuxt": {
            "command": "npx",
