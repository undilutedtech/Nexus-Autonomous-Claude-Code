...
class AgentProcessManager:
    ...
    async def start(self, yolo_mode: bool = False, model: str | None = None) -> tuple[bool, str]:
        ...
        try:
            ...
            # Set PYTHONUNBUFFERED=1 to ensure output is not buffered
            import os
            env = os.environ.copy()
    ...
    async def stop(self) -> tuple[bool, str]:
        ...
        try:
            ...
            # Terminate gracefully first - parent and all children
            ...
            try:
                ...
                # Force kill if still running - parent and all children
                self.process.kill()
                for child in children:
                    try:
                        child.kill()
            ...
            # Clean up any remaining orphaned children
            for child in children:
                try:
                    if child.is_running():
                        child.kill()
