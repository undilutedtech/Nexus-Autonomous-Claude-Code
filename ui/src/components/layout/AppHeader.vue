    ...
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        <div class="flex items-center gap-2 2xsm:gap-3">
          ...
          <router-link
            to="/projects/new"
            class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white transition-colors rounded-lg bg-brand-500 hover:bg-brand-600 dark:bg-brand-600 dark:hover:bg-brand-500"
          >
            <svg
              class="w-4 h-4"
              fill="none"
